...
// GLOBAL VARIABLES
let baseURL = "./"
let baseURL_local = "https://raym.app/maps_uaf/"
let gameLoading = true;
let currentJSON = null;
let gamesJSON = null;
let levelsJSON = null;
let baseTitle = "Ubi-Canvas"
...
function startGame() {
	gameInstance = UnityLoader.instantiate("gameContainer", "Build/ubicanvas.json", {onProgress: UnityProgress});
}
