namespace UbiArt.ITF {
	[Games(GameFlags.COL)]
	public partial class COL_FeedbackHUD_Template : UIMenuBasic_Template {
		public Path textureActionMessageBackground;
		public GFXMaterialSerializable textureActionMessageBackgroundMaterial;
		...
		protected override void SerializeImpl(CSerializerObject s) {
			...
			textureActionMessageBackgroundMaterial = s.SerializeObject<GFXMaterialSerializable>(textureActionMessageBackgroundMaterial, name: "textureActionMessageBackgroundMaterial");
