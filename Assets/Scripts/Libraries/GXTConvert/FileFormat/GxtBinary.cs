    ...
    public class GxtBinary
    {
        ...
        public GxtBinary(Stream stream)
        {
            ...
            /*if (BUVChunk != null)
            {
                ...
                BUVTextures = new Texture2D[BUVChunk.Entries.Length];
                for (int i = 0; i < BUVTextures.Length; i++)
                {
                    BUVEntry entry = BUVChunk.Entries[i];
                    using (Texture2D sourceImage = bundle.CreateTexture(FetchPalette(bundle.TextureFormat, entry.PaletteIndex)))
                    {
        ...
        private void ReadAllTextures(BinaryReader reader)
        {
            ...
            Textures = new Texture2D[TextureBundles.Length];
		...
		public static UnityEngine.Color ColorFromArgb(byte a, byte r, byte g, byte b) {
        ...
        private Color[] FetchPalette(SceGxmTextureFormat textureFormat, int paletteIndex)
        {
            ...
            {
                case SceGxmTextureFormat.P4_ABGR: palette = CreatePalette(P4Palettes[paletteIndex], ((a, b, g, r) => { return ColorFromArgb(a, b, g, r); })); break;
                case SceGxmTextureFormat.P4_ARGB: palette = CreatePalette(P4Palettes[paletteIndex], ((a, b, g, r) => { return ColorFromArgb(a, r, g, b); })); break;
                case SceGxmTextureFormat.P4_RGBA: palette = CreatePalette(P4Palettes[paletteIndex], ((a, b, g, r) => { return ColorFromArgb(r, g, b, a); })); break;
                case SceGxmTextureFormat.P4_BGRA: palette = CreatePalette(P4Palettes[paletteIndex], ((a, b, g, r) => { return ColorFromArgb(b, g, r, a); })); break;
                case SceGxmTextureFormat.P4_1BGR: palette = CreatePalette(P4Palettes[paletteIndex], ((a, b, g, r) => { return ColorFromArgb(0xFF, b, g, r); })); break;
                case SceGxmTextureFormat.P4_1RGB: palette = CreatePalette(P4Palettes[paletteIndex], ((a, b, g, r) => { return ColorFromArgb(0xFF, r, g, b); })); break;
                case SceGxmTextureFormat.P4_RGB1: palette = CreatePalette(P4Palettes[paletteIndex], ((a, b, g, r) => { return ColorFromArgb(r, g, b, 0xFF); })); break;
                case SceGxmTextureFormat.P4_BGR1: palette = CreatePalette(P4Palettes[paletteIndex], ((a, b, g, r) => { return ColorFromArgb(b, g, r, 0xFF); })); break;

				case SceGxmTextureFormat.P8_ABGR: palette = CreatePalette(P8Palettes[paletteIndex], ((a, b, g, r) => { return ColorFromArgb(a, b, g, r); })); break;
                case SceGxmTextureFormat.P8_ARGB: palette = CreatePalette(P8Palettes[paletteIndex], ((a, b, g, r) => { return ColorFromArgb(a, r, g, b); })); break;
                case SceGxmTextureFormat.P8_RGBA: palette = CreatePalette(P8Palettes[paletteIndex], ((a, b, g, r) => { return ColorFromArgb(r, g, b, a); })); break;
                case SceGxmTextureFormat.P8_BGRA: palette = CreatePalette(P8Palettes[paletteIndex], ((a, b, g, r) => { return ColorFromArgb(b, g, r, a); })); break;
                case SceGxmTextureFormat.P8_1BGR: palette = CreatePalette(P8Palettes[paletteIndex], ((a, b, g, r) => { return ColorFromArgb(0xFF, b, g, r); })); break;
                case SceGxmTextureFormat.P8_1RGB: palette = CreatePalette(P8Palettes[paletteIndex], ((a, b, g, r) => { return ColorFromArgb(0xFF, r, g, b); })); break;
                case SceGxmTextureFormat.P8_RGB1: palette = CreatePalette(P8Palettes[paletteIndex], ((a, b, g, r) => { return ColorFromArgb(r, g, b, 0xFF); })); break;
                case SceGxmTextureFormat.P8_BGR1: palette = CreatePalette(P8Palettes[paletteIndex], ((a, b, g, r) => { return ColorFromArgb(b, g, r, 0xFF); })); break;
